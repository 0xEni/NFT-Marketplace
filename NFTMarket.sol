...
contract NFTMarket is ReentrancyGuard {
    ...
    function createMarketSale(address nftContract, uint itemId) public payable nonReentrant {
        ...
        idToMarketItem[itemId].owner = payable(msg.sender); // Changing owner to the buyer
        idToMarketItem[itemId].sold = true;
        payable(owner).transfer(listingPrice); //transfer listing amount to marketplace owner.
    }
